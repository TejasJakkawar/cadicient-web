...
export default function Footer() {
  return (
    <footer className="bg-[#181716] w-full pt-12 pb-9 font-sans">
      {/* Newsletter Signup */}
      <div className="w-full flex justify-center mb-12 px-4">
        <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <form className="flex w-full lg:w-[430px] h-12 justify-end">
            <input
              type="email"
              placeholder="Your Email Here"
              className="flex-1 bg-white text-black px-5 h-12 rounded-l-lg text-base font-medium outline-none"
            />
            <button
              type="submit"
              className="bg-[#F36B39] hover:bg-[#fc844d] text-white font-bold px-8 rounded-r-lg text-base transition h-12"
            >
              SUBSCRIBE
            </button>
          </form>
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-4 gap-y-12 gap-x-10">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <div className="text-white text-lg leading-snug mb-7 mt-2 font-medium max-w-xs">
              Delivering innovative and precise civil engineering solutions with
              a focus on quality, sustainability, and client satisfaction.
            </div>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <div className="space-y-6 w-full">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-bold text-base text-white leading-tight">
                    Unveiling The Power Of Efficiency In CAD Drafting For Civil
                    Engineering
                  </div>
                  <div className="text-gray-400 text-xs mt-1">
                    July 9, 2024 - No Comments
      ...
      <div className="w-full flex justify-center">
        <div className="max-w-6xl w-full text-gray-400 text-xs text-right mt-9 pr-1">
