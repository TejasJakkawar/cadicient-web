  ...
  return (
    <div id="about" className="about-us-component">
      ...
      <div className="content-div">
        <ScrollAnimated animation="slideLeft" delay={0.3}>
        ...
        <ScrollAnimated animation="bounceIn" delay={0.4}>
      ...
      <ScrollAnimated animation="scaleIn" delay={0.2}>
      ...
      <ScrollAnimated animation="slideRight" delay={0.2}>
